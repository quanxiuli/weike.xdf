...
function updateExhibitionUser(pid, userId, loginId, userName, email, department, position, school, areaCode, deptCode, schoolCode) {
    window.location.href = 'userUpdate.html?pid=' + pid + "&userId=" + userId + "&loginId=" + loginId + "&email=" + email + "&department=" + department + "&position=" + position + "&school=" + school + "&deptCode=" + deptCode + "&userName=" + encodeURI(userName) + "&areaCode=" + areaCode + "&schoolCode=" + schoolCode;
