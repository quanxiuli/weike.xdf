                ...
                if (a = $("button", a)[0], "view" == d.mode) {
                    var b = function(b, c) {
                            ...
                            $("textarea", e).each(function() {
                                ...
                                cache: !0,
                                type: "POST",
                                url: JSON_URL + "ajax_scenedataadd?id=" + c,
                                data: $.param(f),
                                async: !1,
                                error: function() {
                                    alert("Connection error")
        ...
        function() {
            ...
            function(a, b, c, d, e, f) {
                ...
                g = a.uploader = new b(a.category.scratch || a.category.headerImage ? {
                    url: JSON_URL+"ajax_upfileupload?ID=" + getCookie("USERID") + "&keycode=" + getCookie("MD5STR") + "&bizType=" + d.categoryId + "&fileType=" + d.fileType,
                    withCredentials: !0,
                    queueLimit: 1,
                ...
                var v = {},
                    w = {
                        ...
                        requestCurrentUser: function() {
                            ...
                            var a = new Date;
                            return b.get(JSON_URL + "ajax_usercheck", {
                                withCredentials: !0
                            }).then(function(a) {
                        ...
                        thirdPartyUrl: {
                            weiChatUrl: "https://open.weixin.qq.com/connect/qrconnect?appid=wxc5f1bbae4bb93ced&redirect_uri=http%3A%2F%2Fabcde.com&response_type=code&scope=snsapi_login&state=STATE#wechat_redirect",
                            qqUrl: "https://graph.qq.com/oauth2.0/authorize?response_type=token&client_id=101149132&redirect_uri=http%3A%2F%2Fabcde.com&scope=get_user_info",
                            weiboUrl: "https://api.weibo.com/oauth2/authorize?client_id=3508809852&response_type=token&redirect_uri=http://abcde.com"
                        },
        ...
        function() {
            ...
            function(a) {
                ...
                return b.getDataBySceneId = function(b, c, d) {
                    c = c || 1, d = d || 10;
                    var e = "ajax_scenedatagetdata?id=" + b + "&pageNo=" + c + "&pageSize=" + d,
                        f = new Date;
            ...
            function(a) {
                ...
                return b.listFileCategory = function(b) {
                    ...
                    var c = "ajax_upfilesystag?type=11";
                    ...
                    var f = "ajax_upfilesyslist?";
                    0 == d && 2 == e && (f = "ajax_upfileuserlist?"), f += "pageNo=" + (b ? b : 1), f += "&pageSize=" + (c ? c : 12), d && "all" != d && (f += "&bizType=" + (d ? d : -1)), f += "&fileType=" + (e ? e : -1);
                    var g = new Date;
            ...
            function(a) {
                ...
                return b.getPageTpls = function(b) {
                    var c = "ajax_scenesyspagetpl?id=" + b,
                        d = new Date;
                    ...
                    var c = "ajax_upfilesystag?type=1";
            ...
            function(a, c, d, e, f, g) {
                ...
                return D.addInterceptor(function(a, e) {
                    ...
                    var c = JSON_URL + "ajax_scenecreatebysys";
                    return a({
                        withCredentials: !0,
                        method: "POST",
                        url: c,
                    ...
                    var f = "";
                    c || d ? (f = "ajax_scenecreatepage?id=" + b, d && (f += "&copy=true")) : f = "ajax_scenedesign?id=" + b;
                    var g = e.defer(),
                        h = new Date;
                    ...
                    if (c.get(b)) {
                        ...
                        var k = "ajax_scenesyspageinfo?id=" + b,
                            l = new Date;
                    ...
                    var d = "ajax_upfilesystag?type=2&bizType=" + c,
                        e = new Date;
                    return d += (/\?/.test(d) ? "&" : "?") + "time=" + e.getTime(), a({
                        withCredentials: !0,
                        method: "GET",
