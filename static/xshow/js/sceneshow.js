        ...
        if (a = $("button", a)[0], "view" == c.mode) {
            var d = function() {
                ...
                $("textarea", f).each(function() {
                    ...
                    cache: !0,
                    type: "POST",
                    url: PREFIX_HOST + "ajax_scenedataadd?id=" + b.sceneId,
                    data: $.param(g),
                    async: !1,
                    error: function() {
                        alert("Connection error")
...
! function($) {
    ...
    function parseJson(a) {
        ...
        var b = a.list,
            ...
            d = !1,
            e = a.obj.image;
        if (b.length <= 0) return alert("此场景不存在"), void(); //window.location.href = "http://abcde.com" BY TERRY
