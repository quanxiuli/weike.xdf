...
angular.module("app", ["ngRoute", "spread", "ui.bootstrap", "ngSanitize", "ui.select", "main.data", "services.i18nNotifications", "services.httpRequestTracker", "services.config", "security.register.company", "security", "templates-app", "templates-common", "ui.sortable", "I18N.MESSAGES", "app.directives.notification", "common.directives.dropDown", "common.directives.scroll", "usercenter", "test", "eqxAuth"]), angular.module("app").config(["$routeProvider", "$locationProvider", "securityAuthorizationProvider", "uiSelectConfig", "$provide", "$httpProvider", "$tooltipProvider", "authServiceProvider", function(a, b, c, d, e, f, g, h) {
	...
	}, c.suggestionUrl = "", c.feedbackUrl = "", c.qqChatUrl = "", c.helpUrl = "", c.createSkillUrl = "", c.safeApply = function(a) {
	...
	a.apply || (a.apply = {}), a.applyObj = c, 2 == c.type ? (a.title = "申请加入秀场", a.description = "申请加入官方秀场平台，获取更多朋友的关注", f.getTagSysListWithType().then(function(b) {
		var c = b.data.list || [];
	...
	})) : 1 == c.type ? (a.title = "申请成为样例", a.description = "申请推荐，成为其他用户创建场景的原型样例", 4 == b.user.type && d.sceneTplPricesPromise.then(function(b) {
	...
	a.$watch("user", function(a) {
		...
		return 1 == a.isExpedited ? void i.openMsgDialog({
			...
			window.open("/xshow/index#/scene/create/" + a.id + "?pageId=1", "_self")
		}, function() {}) : window.open("/xshow/index#/scene/create/" + a.id + "?pageId=1", "_self"))
		...
		return 1 == b.isExpedited ? void i.openMsgDialog({
			...
			window.open("/xshow/index#/scene/create/" + b.id + "?pageId=1&openSetting=show", "_self")
		}, function() {}) : window.open("/xshow/index#/scene/create/" + b.id + "?pageId=1&openSetting=show", "_self")))
		...
		1 === c.staticStatus ? i.openConfirmDialog({
			...
			f.publishScene(c.id, d).then(function(b) {
				b.data.success ? (k.clear("sceneList"), c.publishTime = (new Date).getTime(), d ? i.openMsgDialog({
					msg: '该场景已经提交审核，系统会尽快给出审核结果并以系统消息形式给出，请耐心等待<br />',
					btn: "关闭"
				}, function() {
		...
		a.viewControl.tab = b, a.viewControl.subtab = "summeryViewInfo", c.path("share/" + d.sceneId + "/summeryViewInfo", !1) //statistics/
	}, a.dataCollect = function(b) {
		a.viewControl.tab = b, a.viewControl.subtab = "dataCollect",c.path("share/" + d.sceneId+"/dataCollect", !1)
	}, a.siteImport = function(b) {
		a.viewControl.tab = b, a.viewControl.subtab = "siteImport",c.path("share/" + d.sceneId+"/siteImport", !1)
	}, a.boardsCollect = function(b) {
		a.viewControl.tab = b, c.path("share/" + d.sceneId+"/boardsCollect", !1)
	...
	var o = PREFIX_S3_URL + "ajax_scenedataexcel?flag=noheader&id=" + b.sceneId + (n ? "&user=" + n : ""),
		p = PREFIX_S3_URL + "ajax_scenedataexcel?id=" + b.sceneId + (n ? "&user=" + n : "");
	...
	b.dataDelete = function() {
		...
		"formData" != b.dataTable && (p = PREFIX_S3_URL + "ajax_scenedataexcel?id=" + b.sceneId + (n ? "&user=" + n : ""), b.dataTable = "formData", b.page.currentPage = 1, b.dataShow = [], l = [], b.dataShowList = [], h(b.sceneId, b.page.currentPage, 10))
	...
	a.summeryExpandWeb = {
		...
		a.selectedExpandWeb = b, b ? a.selectedExpandWebUrl = (a.selectedUrl || PREFIX_HOST + "xshow/v/" + a.scene.code) + "?qrc=" + b.id : a.selectedExpandWebUrl = "", e()
	...
	function e() {
		b.contentTexts = [{
			...
			url: '<iframe width=320px frameborder=0 height=641px src="' + b.selectedUrl + '"></iframe>',
	...
	b.$watch("user", function(c) {
		if (c) {
			...
			f = a.user && a.user.domain ? "http://" + a.user.domain : a.PREFIX_CLIENT_HOST, d.getSceneDetail(b.sceneId).then(function() {
				b.url = b.selectedUrl = f + "/xshow/v/" + b.scene.code, e()
			})
		}
	}, !0)
	...
	b.obj = {}, b.qrCodeShow = !1, b.qrcodeList = [{
		...
		b.sinaurl = "http://service.weibo.com/share/share.php?url=" + encodeURIComponent(b.previewUrl) + "?from=sina_weibo&title=" + encodeURIComponent(b.scene.name) + "&pic=" + encodeURIComponent(PREFIX_FILE_HOST + b.scene.cover) + "&appkey=", b.qqurl = "http://connect.qq.com/widget/shareqq/index.html?url=" + encodeURIComponent(b.previewUrl) + "?from=sqq&title=" + b.scene.name + "&site=&summary=" + (b.scene.description ? b.scene.description : "") + "&pic=" + PREFIX_FILE_HOST + b.scene.cover + "&desc=" + (b.scene.description ? b.scene.description : "") + "&appkey=", b.qqzoneurl = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" + encodeURIComponent(b.previewUrl) + "?from=qzone&title=" + b.scene.name + "&site=&summary=" + (b.scene.description ? b.scene.description : "") + "&pic=" + PREFIX_FILE_HOST + b.scene.cover + "&desc=" + (b.scene.description ? b.scene.description : "") + "&appkey="
	}), b.shareList = [{
		id: 1,
		type: "sina",
		icon: "eqf-weibo",
	...
	b.showTab = function(a) {
		...
		e.getUserInfo().then(function(a) {
			b.userinfo = a.data.obj, b.master = angular.copy(b.userinfo), b.url = "我做的企业秀，好用，你试试吧：\r\n" , b.userinfo.headImg && b.userinfo.headImg.indexOf("http://") >= 0 && (b.thirdHead = !0);
	...
	return {
		...
		link: function(a, b, c) {
			...
			a.$watch("qrUrl", function(a) {
				$("canvas", b).length > 0 && $("canvas", b).remove(), a && (a = a.replace(PREFIX_HOST, PREFIX_HOST_ARRAY[0]), $(b).qrcode({
					render: "canvas",
					width: d,
					height: d,
					text: a + (/\?/.test(a) ? "&" : "?") + "eqrcode=1"
	...
	var b = [PREFIX_URL + "login", PREFIX_URL + "ajax_scenecreatepage?id=", PREFIX_URL + "m/scene/pageList", PREFIX_URL + "ajax_upfileupload", PREFIX_URL + "m/c/group/create", PREFIX_URL + "ajax_scenemy", PREFIX_URL + "ajax_scenesyslist", PREFIX_URL + "ajax_scenesavesettings", PREFIX_URL + "m/scene/stat"];
	...
	var x = {},
		y = {
			...
			requestCurrentUser: function(d) {
				...
				var e = new Date;
				return y.userPromise ? y.userPromise : (y.userPromise = b.get(PREFIX_URL + "ajax_usercheck", {
					withCredentials: !0
				}).then(function(b) {
	...
	var b = function() {
			var b = PREFIX_S2_URL + "ajax_adlogo";
			return a({
				method: "GET",
				url: b
			})
		...
		c = function() {
			var b = PREFIX_S2_URL + "ajax_adbanner";
			return a({
				method: "GET",
				url: b
			})
		...
		d = function() {
			var b = PREFIX_S2_URL + "ajax_adfriendlinks";
			return a({
				method: "GET",
				url: b
			})
	...
	return c.getDatas = function(c) {
		...
		c = c || 1, d = d || 10;
		var f = "ajax_scenedatagetdata?id=" + b + "&pageNo=" + c + "&pageSize=" + d;
		e && (f += (/\?/.test(f) ? "&" : "?") + "user=" + e);
		var g = new Date;
		...
		c = c || 1, d = d || 10;
		var f = "ajax_scenedatagetmsgdata?id=" + b + "&pageNo=" + c + "&pageSize=" + d;
		e && (f += (/\?/.test(f) ? "&" : "?") + "user=" + e);
		var g = new Date;
		return f += "&time=" + g.getTime(), a({
			withCredentials: !0,
		...
		var d = "ajax_scenedatadelete?sceneId=" + b + "&dataIds=" + c.ids;
		return a({
			withCredentials: !0,
			method: "GET",
			url: PREFIX_URL + d,
		...
		var d = "ajax_scenemsgdatadelete?date=" + Date.now(),
			e = {
				sceneId: b,
				ids: c.ids.join(",")
			};
	...
	return c.getNewSample = function() {
		...
		var d = "ajax_scenemygroup?param=" + c;
		...
		var e = "ajax_scenedeletegroup?id=" + c;
		...
		var k;
		k = d ? "ajax_scenemy" + d : "ajax_scenemy";
		var l = {
			showData: i,
			pageNo: e,
			pageSize: f,
	...
	return f.getPageTpls = function(b) {
		...
		var c = "ajax_staticstaglist?type=1";
		...
		var c = "ajax_upfilesystag?type=2";
		null != b && (c += (/\?/.test(c) ? "&" : "?") + "bizType=" + b);
		var d = new Date;
		return c += (/\?/.test(c) ? "&" : "?") + "time=" + d.getTime(), a({
			withCredentials: !0,
	...
	return j.getPageNames = function(b) {
		var c = "ajax_scenepagelist?id=" + b + "?date=" + (new Date).getTime();
		return a({
			withCredentials: !0,
			method: "GET",
			url: PREFIX_URL + c
		...
		var b = PREFIX_URL + "ajax_staticsscenetemplateprices";
		return a({
			withCredentials: !0,
			method: "GET",
			url: b
		...
		var c = PREFIX_URL + "ajax_scenecreatebysys";
		return a({
			withCredentials: !0,
			method: "POST",
			url: c,
		...
		var c = "ajax_scenecreatebycopy?id=" + b;
		return a({
			withCredentials: !0,
			method: "GET",
			url: PREFIX_URL + c
		...
		var b = "ajax_upfileuserlist?bizType=99&fileType=1&time=" + (new Date).getTime();
		return a({
			withCredentials: !0,
			method: "GET",
			url: PREFIX_URL + b
		...
		var c = "ajax_scenesyspageinfo?id=" + b,
			e = (d.defer(), new Date);
		...
		var c = PREFIX_S2_URL + "ajax_adbanners?pageCode=" + b;
		new Date;
		return a({
			method: "GET",
			url: c
	...
	return c.getUserInfo = function() {
		var b = PREFIX_URL + "ajax_usercheck";
		...
		var c = PREFIX_URL + "ajax_usergivexd";
		...
		var e = PREFIX_URL + "ajax_userxdlog?pageNo=" + c + "&pageSize=" + d;
		...
		var b = PREFIX_URL + "ajax_userxdstat";
		return b += "&time=" + (new Date).getTime(), a({
			withCredentials: !0,
			method: "GET",
			url: b
		...
		var f = PREFIX_URL + "ajax_staticsmsglist?pageNo=" + b + "&pageSize=" + c;
	...
	a.put("dialog/message.tpl.html", '<div class=modal-header><span class="glyphicon glyphicon-exclamation-sign"></span> <span>{{msgObj.title || (\'提示\')}}</span></div><div class=modal-body ng-if=msgObj.msg><div class="msg text-center" ng-class="msgObj.title ? \'\' : \'msg-padding\'" ng-bind-html=msgObj.msg></div></div><div class=modal-footer><a ng-click=close(); class="btn btn-primary" style="width: 88px">{{msgObj.btn || (\'关闭\')}}</a></div>')
		...
		var footer_str='<div class=scroll data-ng-init=load2()><a class=scroll_top ng-click=goTop()><span class=eqf-clickmore2></span> <span>顶部</span></a></div><div class=app-download><div style=position:relative;height:40px;width:40px><a class="scroll_top bgScroll" ng-click=downApp() ng-show=appIconDown><span class=eqf-phone></span> <span>APP</span></a></div><div ng-hide=appIconDown class=qrcode-download><div class="closedown eqf-wrong" ng-click=closeDown() title=关闭></div><div qr-code qr-url="{{PREFIX_CLIENT_HOST + \'/appdown.html\'}}"></div></div></div><div class=video-user><a target=_blank href=http://class.qq.com/class/13657/p62157.html><span class=eqf-top-video></span> <span>教程</span></a> </div><footer><div class=help-contain><div class="same-content clearfix"><div class="home-help fl"><ul><li></li><li></li><li></li><li></li></ul></div><div class="home-help fl"><ul><li></li><li></li><li></li><li></li></ul></div><div class="home-help fl"><ul><li></li><li></li><li></li></ul></div><div class="home-help fl"><ul><li></li><li></li><li></li><li></li></ul></div><div class="home-help fl" style=width:140px><ul><li></li><li></li><li></li><li></li></ul></div></div></div><div class="contact-friend same-content" ng-if="friendLinks.length > 0"><ul class=clearfix><li ng-repeat="link in friendLinks"><a target=_blank ng-href={{link.url}}>{{link.name}}</a></li></ul></div><div class="same-content clearfix pt20 pb20"><div class=fr style=width:270px><div class=fr style=background-color:#fff><img ng-src={{CLIENT_CDN}}assets/images/home/QRcode.svg width="80px" height="80px;"></div></div><div class=fl><div class=renzheng style=padding-top:10px></div></div></div></footer>';
	...
	if(web_muban_status==3){footer_str="<footer>\n" +
		...
		a.put("header.tpl.html", '<div class=header-wap><div class=header-contain><div class="same-content clearfix"><div class=head_nav ng-if=showToolBar();><ul class="clearfix head_navs"><li class=background-color-width-change ng-class="{isActive: false}"></li><li ng-if="(user.type == 21 && userPermit.indexOf(\',1101,\') >= 0) || user.type !=21" ng-class="{isActive: isActive == \'customer\'}" class=background-color-width-change></li><li ng-class="{isActive: false}" class=background-color-width-change></li></ul><login-toolbar></login-toolbar></div><a href=/#/main class="hint--bottom hint--rounded" id=logo><img ng-src="{{logoSrc}}"></a></div></div></div>')
	...
	a.put("main/downApp.tpl.html", '<div class=login-form-section><div class=login-content><div class=section-title style=margin-bottom:20px><a class="bbs-help-tip eqf-wrong fr" ng-click=$dismiss()></a></div><div class=down-code><p style=padding-bottom:40px;padding-top:10px>一键生成H5，随时随地查数据</p></div></div></div>')
	...
	a.put("spread/console/guarantee-apply.tpl.html", '')
	...
	a.put("spread/spread.tpl.html", '<div ng-include="\'header.tpl.html\'"></div><div id=main class=min_contain><div ng-include="\'sysmessage.tpl.html\'"></div><div class=info-show><div class=same-content><div class="spread-area clearfix"><div class="scene-oper opera-userinfo"><a class="btn btn-border opa-btn background-color-width-change" target=_blank ng-click=viewScene($event)><span class=eqf-eye style=font-size:12px></span> &nbsp;预览场景</a> <a ng-if=!branchid class="btn btn-border opa-btn edit-scene background-color-width-change" ng-click=editScene(scene)><span class=eqf-write></span> &nbsp;编辑场景</a> <a ng-if=!branchid class="btn btn-border opa-btn edit-scene background-color-width-change" ng-click=sceneSettings($event,scene)><span class=eqf-scene-setting></span> &nbsp;设置场景</a></div><div class="scene-cover fl"><img ng-src="{{PREFIX_FILE_HOST + scene.cover}}"></div><div class=scene-detail><div class=scene-name>{{scene.name}}</div><div class="fade-color scene-tip"><span>{{scene.description || \'未添加描述\'}}</span></div><div class="fade-color scene-tip"><span class=first-col style="width: 180px">创建时间： {{scene.createTime | date:\'yyyy年MM月dd日\'}}</span> <span>最后更新： {{scene.updateTime | date:\'yyyy年MM月dd日\'}}</span></div><div class="fade-color scene-tip" ng-show=branchid><span class=first-col>场景状态：{{sceneStadus}}</span></div><div class="fade-color scene-tip" ng-show=!branchid><div class=first-col><span ng-class="{fl: (scene.status == 1 || scene.status == 2) && scene.publishTime}" style=padding-top:3px>场景状态：</span><div class="switch switch-open hint--bottom hint--rounded" data-hint=点击关闭场景 ng-show="scene.bizType !=30 && scene.status == 1 && scene.publishTime " ng-click=openScene(scene.status,false)><div class=circle-con><i class=circle></i></div></div><div class="switch switch-close hint--bottom hint--rounded" data-hint=点击开放场景 ng-show="scene.bizType !=30 && scene.status == 2 && scene.publishTime" ng-click="openScene(scene.status ,true)"><div class=circle-con><i class=circle></i></div></div><span ng-show="scene.bizType !=30 && !scene.publishTime && (scene.status == 2 || scene.status == 1)">未发布</span> <span ng-show="scene.status==-1">审核被拒绝</span> <span ng-show="scene.status==-2">审核中</span></div></div></div></div><div class=spread-tab><ul class="clearfix tab-line"><li ng-if="(user.type ==21 && userPermit.indexOf(\',1301,\') >= 0) || user.type !=21"><a ng-class="{active: viewControl.subtab == \'socialShare\'}" ng-click="showShare(\'share\');">分享推广</a></li><li ng-if="(user.type == 21 && userPermit.indexOf(\',1303,\') >= 0) || user.type !=21"><a ng-class="{active: viewControl.subtab == \'dataCollect\'}" ng-click="dataCollect(\'dataCollect\');">数据汇总</a></li></ul></div></div></div><div class=same-content><div id=share ng-if="viewControl.tab == \'share\'" ng-controller=ShareCtrl><div ng-include="\'spread/tab/share.tpl.html\'"></div></div><div id=statistics ng-if="viewControl.subtab == \'statistics\'" ng-controller=StatisticsCtrl><div ng-include="\'spread/tab/statistics.tpl.html\'"></div></div><div id=dataCollect ng-if="viewControl.subtab == \'dataCollect\'" ng-controller=DataCollectCtrl><div ng-include="\'spread/tab/data-collect.tpl.html\'"></div></div></div></div><div ng-include="\'footer.tpl.html\'"></div>')
	...
	a.put("usercenter/buyXd.tpl.html", '')
	...
	a.put("usercenter/payment.tpl.html", '')
	...
	a.put("security/login/toolbar.tpl.html", '<ul class="nav pull-right clearfix" style=margin-right:0px;position:relative><li class="" style=width:150px;margin-top:-2px;cursor:pointer ng-show=sendXd.state><img ng-click=openReg() ng-src="{{CLIENT_CDN}}assets/images/xiudianyaoqing.png"></li><li class="mes_con dropdown" style=position:static><div style=position:relative;padding-top:5px;display:none; class="hint--right hint--rounded" data-hint=消息><a class="mes_content eqf-music dropdown-toggle background-color-width-change" style="position: relative" ng-click=openMsgPanel()></a> <span class=mes_count ng-if=newMsgCount>{{newMsgCount}}</span></div><div class="dropdown-menu msg_pannel box-shadow zoomIn-change" role=menu forbidden-close style="transform-origin: 100% 0"><div class="msg-title clearfix"><div class="panel_title pull-left"><em>您有</em><span class=mes_new>{{newMsgCount}}</span><em>新消息</em></div><div class="panel_title text-right" style=margin-left:0px><a ng-click=setRead() ng-if=false>设为已读消息</a></div></div><div ng-if="newMsgs.length>0" class="panel_content head_list_newMsg ellipsis" ng-repeat="newMsg in newMsgs"><em ng-class="{new_msg: newMsg.status == 1}"></em><a href=/#/message ng-bind-html=newMsg.content></a></div><div class="panel_more text-center"><a href=/#/message>查看全部消息 >></a></div></div></li><li ng-show=isAuthenticated() ng-class="{\'border-img\': (user.type == 2 || user.type == 5) && showBranchSelect}" class="custom_img background-color-width-change" ng-mouseover="showCode = true" ng-mouseleave="showCode = false"><div class=head_hover><div class=vip_c><a ng-href=/#/usercenter/account><em ng-if=!currentUser.headImg class=eqf-top-contact></em> <img ng-if=currentUser.headImg ng-src="{{currentUser.headImg.indexOf(\'http\') < 0 ? (PREFIX_FILE_HOST + currentUser.headImg):headImg }}"></a></div><div class="head_click box-shadow" ng-show="showCode == true"><div class=itemList><a href="/operation/logout">退出</a></div></div></div></li><li class="head-creat transform-change" ng-if="myScene && !branchid"><a href=/scene class=""><em class=eqf-plus2></em></a></li></ul>')
}]), angular.module("security/register/companyReg.tpl.html", []).run(["$templateCache", function(a) {
	a.put("security/register/companyReg.tpl.html", '')
